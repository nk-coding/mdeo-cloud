 ...
 *
 * Compiles float literal expressions into a [TraversalCompilationResult] containing
...
class FloatLiteralCompiler : ExpressionCompiler {
     ...
     * @return A [TraversalCompilationResult] producing the float value
     */
    override fun compile(
        ...
        return TraversalCompilationResult.constant(floatValue, initialTraversal)
    }
}
