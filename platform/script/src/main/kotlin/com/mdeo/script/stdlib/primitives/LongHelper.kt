...
object LongHelper {
     ...
     */
    @JvmStatic
    fun iota(start: Long, end: Long, step: Long): com.mdeo.script.stdlib.collections.ScriptList<Int> {
        if (step == 0L) {
     ...
     */
    @JvmStatic
    fun to(start: Long, end: Long): com.mdeo.script.stdlib.collections.ScriptList<Int> {
        val list = com.mdeo.script.stdlib.collections.ListImpl<Int>()
        if (start <= end) {
            for (i in start..end) {
                list.add(i.toInt())
