...
export interface TypedProperty {
    ...
    name: string;
    /**
     * Index into the types array of the TypedAst to resolve the property's type.
     */
    typeIndex: number;
}
...
export interface TypedRelation {
    ...
    isOutgoing: boolean;
    /**
     * Index into the types array of the TypedAst to resolve the relation's type.
     */
    typeIndex: number;
}
...
export interface TypedClass {
    ...
    name: string;
    /**
     * The package name where this class is defined.
     */
    package: string;
    /**
     * Set of fully qualified names of all direct superclasses.
     */
    superClasses: string[];
    /**
     * List of properties defined on this class (not inherited).
     */
    properties: TypedProperty[];
    /**
     * List of relations (both incoming and outgoing) for this class (not inherited).
     */
