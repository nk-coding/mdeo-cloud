import type {
    LangiumCompletionParser as LangiumCompletionParserType,
    LangiumCoreServices,
    LangiumParser as LangiumParserType
} from "langium";
import type { ExtendedParser, ParserOrInfixRule, RuleImpl, RuleOverride, RuleResult } from "./types.js";
import type { EmbeddedActionsParser } from "chevrotain";
import { sharedImport } from "../sharedImport.js";

const { LangiumParser, LangiumCompletionParser, createParser } = sharedImport("langium");
...
export function generateExtendedParser(ruleOverrride: RuleOverride): {
    LangiumParser: (services: LangiumCoreServices) => LangiumParserType;
    CompletionParser: (services: LangiumCoreServices) => LangiumCompletionParserType;
} {
    class ExtendedLangiumParser extends LangiumParser implements ExtendedParser {
    ...
    class ExtendedCompletionParser extends LangiumCompletionParser implements ExtendedParser {
        get chevrotainParser(): EmbeddedActionsParser {
            return this.wrapper;
        }
